        ...
        <SafeAreaView className="flex-1 bg-white" >
            <View className="flex-1 bg-gray-100">
                <View className="p-2 border-b border-[#00CCBB] shadow-xs bg-white justify-center">
                    <View>
                        <Text className="text-center text-black-400 text-lg"  >{restaurant.title}</Text>
                    </View>
                ...
                <View className="p-5 bg-white mt-5 space-y-4">
                    ...
                    <TouchableOpacity onPress={()=>navigation.navigate("Order")} className="rounded-lg p-4 bg-[#00CCBB]">
