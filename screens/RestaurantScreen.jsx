    ...
    return (
        <ScrollView>
            <View className="relative">
                <Image className="w-full h-52 bg-gray-300 p-4"  source={{uri: urlFor(imgUrl).url() }}/>
                <TouchableOpacity onPress={()=> navigation.navigate("Home")} className="absolute top-7 left-5 p-2 bg-white rounded-full">
                ...
                <View className="px-4 pt-4">
                    ...
                    <View className="flex-row items-center my-1 space-x-2">
                        ...
                        <View className="flex-row items-center space-x-1">
                            <Text>📍</Text>
                            <Text className="text-lg text-gray-500" >
                            <Text className="text-black text-lg">Nearby </Text> 
                               · {address}
                            </Text>
                        </View>
                    </View>
